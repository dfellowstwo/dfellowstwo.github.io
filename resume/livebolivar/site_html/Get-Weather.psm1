<#
https://github.com/Smalls1652/Get-Weather
https://www.adamtheautomator.com/powershell-script-orchestrator/
...
function Get-Weather {
    ...
    function getForecast {
        ...
        foreach ($period in $forecastData.properties.periods) {
            ...
            Add-Member -InputObject $forecastPeriod -MemberType NoteProperty -Name "(F)" -Value $period.temperature
            Add-Member -InputObject $forecastPeriod -MemberType NoteProperty -Name "Detailed Forecast" -Value $period.detailedForecast
    ...
    function getHourly {
        ...
        foreach ($period in ($hourlyData.properties.periods | Select-Object -First 40)) {
            $hourlyPeriod = New-Object -TypeName pscustomobject

            $percentChance = getRainChance -iconurl $period.icon

		Add-Member -InputObject $forecastPeriod -MemberType NoteProperty -Name "Day" -Value $period.name
            Add-Member -InputObject $hourlyPeriod -MemberType NoteProperty -Name "(F)" -Value $period.temperature
            Add-Member -InputObject $hourlyPeriod -MemberType NoteProperty -Name "Detailed Forecast" -Value $period.detailedForecast
...
Get-Weather -ZipCode 65613 -forecast