...
"rules":{"my_name_is":{"label":"NAME","fieldtype":"text","required":true},"my_email_address_is":{"email":true,"label":"EMAIL","fieldtype":"email","required":true},"socialsecuritynumber":{"label":"SSN","fieldtype":"text","maxlength":"11","required":true},"my_date_of_birth_is":{"label":"DOB","fieldtype":"text","required":true},"text79":{"label":"LANDLORD","fieldtype":"text","maxlength":"14","required":true},"text80":{"label":"MY PHONE","fieldtype":"text","required":true,"maxlength":"14"},"text77":{"label":"ADDRESS","fieldtype":"text","required":false},"upload1":{"label":"ID","accept":"txt|rtf|jpg|jpeg|png|gif|pdf|bmp|doc|docx|pgp|zip|html|xlsx","files":true,"attach":true,"database":false,"maxbytes":1024000,"fieldtype":"fileupload","required":true}},
"payment_rules":{},
"conditional_rules":{},
