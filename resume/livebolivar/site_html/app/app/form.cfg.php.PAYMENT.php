...
"rules":{"my_name_is":{"label":"NAME (FIRST MIDDLE LAST)","fieldtype":"text","required":true},"my_email_address_is":{"email":true,"label":"EMAIL","fieldtype":"email","required":true},"socialsecuritynumber":{"label":"SSN","fieldtype":"text","maxlength":"11","required":true,"messages":"PUT 123456789 IF YOU DO NOT HAVE A SSN"},"my_date_of_birth_is":{"label":"DOB (MMDDYY)","fieldtype":"text","required":true},"tel82":{"phone":"phoneUS","label":"LANDLORD PHONE","fieldtype":"tel","required":true},"tel83":{"phone":"phoneUS","label":"YOUR PHONE","fieldtype":"tel","required":true},"text77":{"label":"ADDRESS (IF DIFFERENT THAN ID)","fieldtype":"text","required":false},"upload1":{"label":"CLICK BROWSE / CHOOSE TO PHOTOGRAPH YOUR ID.  IT WILL ATTACH.  IT WILL UPLOAD WHEN YOU CLICK THE SUBMIT BUTTON BELOW.","accept":"txt|rtf|jpg|jpeg|png|gif|pdf|bmp|doc|docx|pgp|zip|html|xlsx","files":true,"attach":true,"database":false,"maxbytes":1024000,"fieldtype":"fileupload","required":true}},
"payment_rules":{},
"conditional_rules":{},
