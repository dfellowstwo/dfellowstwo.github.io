...
class Forecaster extends Base {
     ...
     * For the station ID see: https://www.weather.gov/xml/current_obs/
     * Or for an XML list of stations: https://www.weather.gov/xml/current_obs/index.xml
     *
    ...
    public function getCurrentWeather($stationId) {
        ...
        // get the XML data
        $url = sprintf('https://w1.weather.gov/xml/current_obs/%s.xml', $stationId);
     ...
     * Docs: https://graphical.weather.gov/xml/rest.php
     * NDFD Technical: https://www.nws.noaa.gov/ndfd/technical.htm
     *
    ...
    public function getForecastByLatLng($lat, $lng, $startDate=null, $days=7) {
        ...
        $url = sprintf("https://graphical.weather.gov/xml/sample_products/browser_interface/ndfdBrowserClientByDay.php?%s", $queryString);
