...
<title>WEATHER SPRINGFIELD/BOLIVAR, MISSOURI 65613</title>
...
<div class=content>
<!--img src=../images/weather-seven-day-forecast-graphicl-<?php echo $hash2; ?>.jpg title="THANKS TO FOX5KRBK.COM FOR THIS SEVEN DAY OUTLOOK GRAPHIC" alt="THANKS TO FOX5KRBK.COM FOR THIS SEVEN DAY OUTLOOK GRAPHIC.  YOUR CLOCK IS A LITTLE DIFFERENT THAN MINE.  THIS UPDATES AT MIDNIGHT CST/CDT.  REFRESH IN ONE MINUTE OR CLICK ON THIS TO GO TO THE SOURCE.  ../images/weather-seven-day-forecast-graphicl-<?php echo $hash2; ?>.jpg" -->
<img src=../images/weather-seven-day-forecast-graphicl-<?php echo $hash2; ?>.jpg title="THANKS TO KY3.COM FOR THIS SEVEN DAY OUTLOOK GRAPHIC" alt="THANKS TO KY3.COM FOR THIS SEVEN DAY OUTLOOK GRAPHIC.  YOUR CLOCK IS A LITTLE DIFFERENT THAN MINE.  THIS UPDATES AT MIDNIGHT CST/CDT.  REFRESH IN ONE MINUTE OR CLICK ON THIS TO GO TO THE SOURCE.  ../images/weather-seven-day-forecast-graphicl-<?php echo $hash2; ?>.jpg">
</div>
</a>
</div>
<div class="promo six">
...
<a href=http://www.ky3.com/weather>
<div class=content>
<!-- img src=../images/weather-seven-day-forecast-graphicl-<?php echo $hash2; ?>.jpg width=473 height=196 title="THANKS TO FOX5KRBK.COM FOR THIS SEVEN DAY OUTLOOK GRAPHIC" alt="THANKS TO FOX5KRBK.COM FOR THIS SEVEN DAY OUTLOOK GRAPHIC.  YOUR CLOCK IS A LITTLE DIFFERENT THAN MINE.  THIS UPDATES AT MIDNIGHT CST/CDT.  REFRESH IN ONE MINUTE OR CLICK ON THIS TO GO TO THE SOURCE.  ../images/weather-seven-day-forecast-graphicl-<?php echo $hash2; ?>.jpg" -->
...
<a class=hidelg style="float:right; margin:0 0 0 30px" href="../weather-graphic-ky3.php"><img alt="placemark" src="../images/placemark44x31.jpg"></a>
<a class=hidelg style=float:right href="../weather-graphic-fox5krbr.php"><img alt="placemark" src="../images/placemark44x31.jpg"></a>
<div class=clear-fix></div>
</footer>
</div>
</body>
