<title>SUNRISE-SUNSET.PHP</title>
<?php

/*

DOUG.  USED BY MY WEATHER PHP PAGES
...
https://www.weather-watch.com/smf/index.php/topic,32040.0.html
...
$time_format = 'h:i A'; // 08:53 PM PDT



// Set the latitude and longitude for your location

$latitude  = 37.6268; //North

$longitude = -93.4313; //West





// uncomment one zenith setting: https://en.wikipedia.org/wiki/Twilight

$zenith = 89.6+(50/60); // True sunrise/sunset
