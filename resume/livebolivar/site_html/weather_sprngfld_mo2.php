...
if(strlen($a) >= 26)
{
    echo substr($a, 8, 18) . "<br>"; //prints everything after the 8th character and before the 18th character
    echo substr($a, 26) . "<br>";    //prints everything after 26th character
}
...
<div id="right"> <a href="https://www.kspr.com/weather"><img src="https://gray.ftp.clickability.com/ksprwebftp/Seven_Day.JPG" alt="7 DAY FORECAST GRAPHIC. ABC SPRINGFIELD, MO KSPR.COM" TITLE="ABC SPRINGFIELD, MO WEATHER KSPR.COM" width="400" height="227" align="right"></a>
</div>
