...
<link rel="stylesheet" type="text/css"  href="screen_styles16.css" />
<link rel="stylesheet" type="text/css"  href="screen_layout_large16.css" />
<link rel="stylesheet" type="text/css" media="only screen and (min-width:50px) and (max-width:650px)"    href="screen_layout_small16.css">
<link rel="stylesheet" type="text/css" media="only screen and (min-width:601px) and (max-width:1050px)"   href="screen_layout_medium16.css">
...
.promo_container .promo.two img { width: 128px;	display: block;	margin: 0 auto; }
...
.promo_container .promo.one { width: 46%; }		
.promo_container .promo.two { width: 22%; padding: .25em 0; float:left; }	
.promo_container .promo.three { width: 64%; }
}


@media only screen and (max-width:750px){
.promo_container .promo.one { width: 100%; text-align: center;}		
.promo_container .promo.two { width: 100%; padding: .25em 0; }	
.promo_container .promo.three { width: 100%; }
...
$location = 'https://w1.weather.gov/xml/current_obs/KSGF.xml'; // URL TO DOWNLOAD WEATHER DATA FROM
$filename = 'ksgf.xml';
...
<a href=https://w1.weather.gov/xml/current_obs/KSGF.xml>WEATHER DATA (LEFT CLICK GUI / RIGHT CLICK "SAVE AS" XML DATA) 
			...
			<footer style="page-break-inside:avoid;">
				...
				<a href="https://www.google.com/search?source=hp&q=DOUG+FELLOWS+site%3Alivebolivar.com">&#169; DFELLOWS.LIVEBOLIVAR.COM</a>
