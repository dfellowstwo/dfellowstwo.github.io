...
@media only screen and (min-width:801px){article{padding:17em 0 0 0;text-align:center}}
@media only screen and (min-width:810px){article{padding:14em 0 0 0;text-align:center}}
...
<div class=content>
<img src=../images/weather-seven-day-forecast-graphicl-<?php echo $hash2;?>.jpg width="100%" height="100%" alt="SEVEN DAY FORECAST GRAPHIC.  YOUR CLOCK IS A LITTLE DIFFERENT THAN MINE.  THIS UPDATES AT MIDNIGHT CST/CDT.  REFRESH IN ONE MINUTE OR CLICK ON THIS TO GO TO THE SOURCE.  ../images/weather-seven-day-forecast-graphicl-<?php echo $hash2;?>.jpg">
</div></a>
</div>
...
<a href=https://www.fox5krbk.com/weather>
<div class=content>
<img src=../images/weather-seven-day-forecast-graphicl-<?php echo $hash2;?>.jpg width=473 height=196 alt="SEVEN DAY FORECAST GRAPHIC.  YOUR CLOCK IS A LITTLE DIFFERENT THAN MINE.  THIS UPDATES AT MIDNIGHT CST/CDT.  REFRESH IN ONE MINUTE OR CLICK ON THIS TO GO TO THE SOURCE.  ../images/weather-seven-day-forecast-graphicl-<?php echo $hash2;?>.jpg">
</div></a>
</div>
...
<a href=https://www.fox5krbk.com/weather>
<div class=content>
<img src=../images/weather-seven-day-forecast-graphicl-<?php echo $hash2;?>.jpg width=315 height=130 alt="SEVEN DAY FORECAST GRAPHIC.  YOUR CLOCK IS A LITTLE DIFFERENT THAN MINE.  THIS UPDATES AT MIDNIGHT CST/CDT.  REFRESH IN ONE MINUTE OR CLICK ON THIS TO GO TO THE SOURCE.  ../images/weather-seven-day-forecast-graphicl-<?php echo $hash2;?>.jpg">
</div></a>
</div>
