			...
			<div class="promo_container">
				...
				<div class="promo one">
					...
					<div class="content">
                        ...
                        // CACHE BUSTING DATE IN FILENAME

                        /*  https://php.net/manual/en/function.date.php

                            https://stackoverflow.com/questions/24914227/how-to-get-local-time-in-php

                            GODADDY SERVERS ARE IN MOUNTAIN TIME.  I AM IN CENTRAL TIME.

                            AFTER 10PM GODADDY TIME IT IS TOMORROW MY TIME.
                        ...
                        */
                        ...
                        $today=date("mdy", strtotime('tomorrow'));
				...
				<div class="promo two">
                    ...
                    <div class="content">
						...
						<img src="../images/moonphase<?php echo $today; ?>.gif" width="128" height="196" alt="MOON PHASE GRAPHIC.  YOUR CLOCK IS A LITTLE DIFFERENT THAN MINE.  THIS UPDATES AT MIDNIGHT CST/CDT.  REFRESH IN ONE MINUTE OR CLICK ON THIS TO GO TO THE SOURCE.  ../images/moonphase<?php echo $today; ?>.gif">
				...
				<div class="promo three">
           	    ...
           	    <a href="https://www.fox5krbk.com/weather">
					...
					<div class="content">
						...
						<img src="../images/weather-seven-day-forecast-graphicl<?php echo $today; ?>.jpg" width="324" height="196" alt="SEVEN DAY FORECAST GRAPHIC.  YOUR CLOCK IS A LITTLE DIFFERENT THAN MINE.  THIS UPDATES AT MIDNIGHT CST/CDT.  REFRESH IN ONE MINUTE OR CLICK ON THIS TO GO TO THE SOURCE.  ../images/weather-seven-day-forecast-graphicl<?php echo $today; ?>.jpg"> 
                ...
                <div class="promo six">
					...
					<div class="content">
						...
						<img src="../images/weather-seven-day-forecast-graphicp<?php echo $today; ?>.jpg" width="324" height="196" alt="SEVEN DAY FORECAST GRAPHIC.  YOUR CLOCK IS A LITTLE DIFFERENT THAN MINE.  THIS UPDATES AT MIDNIGHT CST/CDT.  REFRESH IN ONE MINUTE OR CLICK ON THIS TO GO TO THE SOURCE.  ../images/weather-seven-day-forecast-graphicp<?php echo $today; ?>.jpg"> 
