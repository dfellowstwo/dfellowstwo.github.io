...
if (array_key_exists('email', $_POST)) {
    ...
    $mail->addAddress('spam@livebolivar.com', 'AJ ELLIS');
...
<!-- begin recapcha https://webdesign.tutsplus.com/tutorials/how-to-integrate-no-captcha-recaptcha-in-your-website--cms-23024 -->
...
<form action="" method="post">
    ...
    <label for="message">Message: <textarea name="message" id="message"></textarea></label><br>
      ...
      <div class="g-recaptcha" data-sitekey="6LfLT2IUAAAAAPrlPV5_GRtHywp70h7SCifEyJkY"></div>
...
if ($_POST["g-recaptcha-response"]) {
 ...
 <!--end recapcha https://webdesign.tutsplus.com/tutorials/how-to-integrate-no-captcha-recaptcha-in-your-website--cms-23024 -->
