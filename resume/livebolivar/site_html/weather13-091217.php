...
<html lang="en">
	<head>
		...
		<style type="text/css">
			...
			article { padding: 17em 0 0 0; text-align: center; }
			}
	...
	<body>
		...
		<div class="page">
			...
			<footer style="page-break-inside:avoid;">
				...
				&#169; LIVEBOLIVAR.COM
				<br>
				<a href="https://www.google.com/#hl=en&amp;output=search&amp;sclient=psy-ab&amp;rlz=1C2_____enUS379&amp;q=doug+fellows+site:livebolivar.com&amp;oq=doug&amp;gs_l=hp.3.0.35i39j44i39i27j0j0i20.1460.4682.0.6146.7.6.1.0.0.0.140.706.0j6.6.0.les%3B..0.0...1c.1.5.psy-ab.l6XLIvERCyw&amp;pbx=1&amp;bav=on.2,or.r_gc.r_pw.r_cp.r_qf.&amp;bvm=bv.43148975,d.b2U&amp;fp=443df112168ae7b8&amp;biw=1440&amp;bih=762">&nbsp;  &nbsp;  WEBMASTER Doug Fellows</a>
				...
				<span class="noPrint">
				    ...
				    <a href="site_html/sitemap13.html"><img class="cssgif" src="placemark88x31.jpg" alt="CALL AJ ELLIS 1-417-327-3911 M-F 9-5.  PROPERTY FOR RENT BOLIVAR, POLK COUNTY, MISSOURI 65613."></a>
