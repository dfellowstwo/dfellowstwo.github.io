...
*	accommodate special needs some users may have due to the server setup they have to deal with.
*	
...
$user_config['mailer']['smtp']['user'] = 'ajellis@livebolivar.com';
$user_config['mailer']['smtp']['password'] = 'august';

// The address of the server
// $user_config['mailer']['smtp']['host'] = 'smtpout.secureserver.net';
// $user_config['mailer']['smtp']['host'] = 'mail.livebolivar.com';
...
// $user_config['mailer']['smtp']['port'] = '587';
// $user_config['mailer']['smtp']['secure'] = '';
