...
<head>
    ...
    <title>WEATHER SPRINGFIELD, MO 1-417-327-3911 AJ ELLIS AJELLIS@LIVEBOLIVAR.COM</title>

<meta name="DESCRIPTION" content="WEATHER RADAR FOR BOLIVAR AND SPRINGFIELD, MISSOURI">
...
<p>AJ ELLIS <a href="TEL:+14173273911">&#49;&#45;&#52;&#49;&#55;&#45;&#51;&#50;&#55;&#45;&#51;&#57;&#49;&#49;</a>&nbsp; <a href="https://www.google.com/maps/dir//LIVEBOLIVAR.COM,+1325+South+Lillian+Avenue+%23212,+Bolivar,+MO+65613/@37.6011562,-93.4147197,17z/data=!4m8!4m7!1m0!1m5!1m1!1s0x87c5bff73c37a583:0xb2990d5cec1a2b09!2m2!1d-93.4156382!2d37.6017893?hl=en" title="CLICK FOR A GOOGLE MAP" data-tooltip="map_address">1325 S. LILLIAN AVE #212, BOLIVAR, MISSOURI 65613</a>&nbsp;&nbsp;MON-FRI 9am-5pm</p>
...
<div id="left">
<!--WDC.PHP IS USED BY "ECHO WrapText ($weather_cond[0]->attributes()->text, 27, 0);" BELOW -->
<!-- <?php // require_once('WDC.PHP')?> -->
<?php
...
/* OLD URL */
  $Bolivar = 12786543;  /* BOLIVAR,MO USA */
  ...
  curl_setopt($ch, CURLOPT_URL, 'https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20weather.forecast%20where%20woeid%3D12786543&diagnostics=true');

  /* OLD URL  
  curl_setopt($ch, CURLOPT_URL, 'https://xml.weather.yahoo.com/forecastrss?p=65613&u=f');
  curl_setopt($ch, CURLOPT_URL, 'https://weather.yahooapis.com/forecastrss?w='.$Bolivar.'&u=f');
  curl_setopt($ch, CURLOPT_URL, 'https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20weather.forecast%20where%20woeid%20in%20(select%20woeid%20from%20geo.places(1)%20where%20text%3D%22bolivar%2Cmo%22)&format=xml&env=store%3A%2F%2Fdatatables.org%2Falltableswithkesy');
...
$weather_wind = $weather->channel->xpath('yweather:wind');
  ...
  $weather_date = $weather->channel->item->xpath('yweather:condition');

  
  $weather_sunrise = $weather->channel->xpath('yweather:astronomy');

  $weather_sunset = $weather->channel->xpath('yweather:astronomy');
 */
...
<a href="https://www.ky3.com/weather">NBC Springfield, MO Weather</a><br>
...
<script language="JavaScript" type="text/javascript" src="https://www.moonmodule.com/cs/ccm_fl.js"> -->
<!--fh:187.2 -->
<div class="left" data-tooltip="moonphase" title="Moon Phase Software $10">
<a href="https://www.quickphase.com/version3/">
<script language="JavaScript" type="text/javascript">var ccm_cfg = { pth:"https://www.moonmodule.com/cs/", fn:"ccm_v1.swf", tc:"FFFFFF", bgc:"000000", mc:"000000", fw:79, fh:150}</script>
<script language="JavaScript" type="text/javascript" src="https://www.moonmodule.com/cs/ccm_fl.js"></script>

<script type='text/javascript'>
var ssa = ea6ee202cbb4b1e;
...
<!--
<div style="width:100px"><div style="padding:2px;background-color:#000000;border: 0px solid #000000"><div style="padding:2px;padding-bottom:3px;padding-top:3px;border: 0px solid #000000"><script language="JavaScript" type="text/javascript">var ccm_cfg = { pth:"https://www.moonmodule.com/cs/", fn:"ccm_v1.swf", lg:"en", hs:1, tf:"12hr", scs:1, df:"std", dfd:0, tc:"FFFFFF", bgc:"000000", mc:"000000", fw:79, fh:100, js:0, msp:0, u:"mc" }</script><script language="JavaScript" type="text/javascript" src="https://www.moonmodule.com/cs/ccm_fl.js"></script><div style="padding-top:3px" align="center"><a href="https://www.moonconnection.com/current_moon_phase.phtml" target="" style="font-size:10px;font-family:arial,verdana,sans-serif;color:#7F7F7F;text-decoration:underline;background:#000000;border:none;"><span style="color:#7F7F7F">$10 software</span></a></div></div></div></div>
Begin Current Moon Phase HTML (c) MoonConnection.com
<div style="width:110px"><div style="padding:2px;background-color:#000000;border: 1px solid #000000"><div style="padding:12px;padding-bottom:3px;padding-top:9px;border: 1px solid #000000" align="center"><script language="JavaScript" type="text/javascript">var ccm_cfg = { pth:"https://www.moonmodule.com/cs/", fn:"ccm_v1.swf", lg:"en", hs:1, tf:"12hr", scs:1, df:"std", dfd:0, tc:"FFFFFF", bgc:"000000", mc:"000000", fw:79, fh:116, js:0, msp:0, u:"mc" }</script><script language="JavaScript" type="text/javascript" src="https://www.moonmodule.com/cs/ccm_fl.js"></script><div style="padding-top:3px" align="center"><a href="https://www.moonconnection.com/moon_cycle.phtml" target="mc_moon_ph" style="font-size:10px;font-family:arial,verdana,sans-serif;color:#7F7F7F;text-decoration:underline;background:#000000;border:none;"><span style="color:#7F7F7F">moon cycle</span></a></div></div></div></div>
 -->

<!--<img src="https://api.usno.navy.mil/imagery/moon.png" width="112" height="112" alt="What the Moon looks like now"> -->
<!--https://www.usno.navy.mil/USNO/time/moon-phase-images -->
<!--<img src="https://api.usno.navy.mil/imagery/moon> -->
<!--https://tycho.usno.navy.mil/cgi-bin/phase.gif -->

<div class="left">
<?php print date('D, M jS, Y'); ?>
<br>
TEMP:&nbsp;<?php print $weather_cond[0]->attributes()->temp; ?> &deg;
<br>  
CONDITIONS:<br>
<!--FOR WRAPTEXT SEE require_once('WDC.PHP') ABOVE -->
<?php // ECHO WrapText ($weather_cond[0]->attributes()->text, 27, 0); ?>
<?php echo wordwrap($weather_cond[0]->attributes()->text, 27, "<br />\n"); ?>
<?php //echo wordwrap("NOW IS THE TIME FOR ALL GOOD MEN TO COME", 27, "<br />\n"); ?>
<br>
WIND:&nbsp;<?php print cardinalize($weather_wind[0]->attributes()->direction); ?> <?php 
          ...
          ?>
<br>
SUNRISE&nbsp;<?php print $weather_sunrise[0]->attributes()->sunrise; ?>
<br>
SUNSET&nbsp;&nbsp;<?php print $weather_sunset[0]->attributes()->sunset; ?>
<br>
<a href="https://www.almanac.com/astronomy/rise/MO/Bolivar/<?php echo date('Y-m-d'); ?>" data-tooltip="almanac_com">PLANETS</a>
<br><br>
<img src="../images/moonphase-placemark.jpg" alt="" width="200" usemap="#MOONPHASE" style="float:left;border:0;width:200px;height:31px">
<map name="MOONPHASE">
<area shape="rect" coords="0,0,50,31" href="https://www.usno.navy.mil/USNO/time/moon-phase-images?v=<?php echo date('Y-m-d'); ?>" title="PAGE WHERE PHASE.GIF IS FOUND" alt="MOONPHASE GIF SOURCE">
<area shape="rect" coords="51,0,100,31" href="https://tycho.usno.navy.mil/cgi-bin/phase.gif?v=<?php echo date('Y-m-d'); ?>" title="PHASE.GIF" alt="MOONPHASE GIF">
<area shape="rect" coords="101,0,150,31" href="https://xml.weather.yahoo.com/forecastrss?p=65613&u=f" title="XML PAGE IS BASED ON" alt="XML PAGE IS BASED ON">
</map>
</div>
<div id="right"> <a href="https://www.kspr.com/weather"><img src="https://www.kspr.com/dynamic-images/transient/image/ksprtv/21683238" alt="" TITLE="KSPR.COM's ABC AFFILIATE IN SPRINGFIELD, MO WEATHER PAGE" width="400" height="227" align="right"></a> 
</div>
...
<a href="https://www.wunderground.com/radar/mosaic.asp">
          ...
          <a href="https://www.wunderground.com/radar/radblast.asp?ID=SGF"></a>
...
<!--<img src="https://radblast-aa.wunderground.com/cgi-bin/radar/WUNIDS_map?station=SGF&amp;brand=wui&amp;num=6&amp;delay=15&amp;type=N0R&amp;frame=0&amp;scale=0.125&amp;noclutter=1&amp;t=1190809588&amp;lat=0&amp;lon=0&amp;label=you&amp;showstorms=0&amp;map.x=400&amp;map.y=240&amp;centerx=470&amp;centery=530&amp;transx=70&amp;transy=290&amp;showlabels=1&amp;severe=0&amp;rainsnow=0&amp;lightning=0" alt="RADBLAST-AA.WUNDERGROUND.COM 5 MILE ANIMATED RADAR." title="5 MILE RADAR AROUND BOLIVAR, MISSOURI" style="border: 0px solid;" border="0" height="563" width="750"> -->
<a href="https://www.wunderground.com/radar/radblast.asp?ID=SGF" title="Weather Bolivar,MO 30mile radar from wunderground.com" ></a>
