...
<title>WEATHER18 SPRINGFIELD/BOLIVAR, MISSOURI 65613</title>
...
@media only screen and (min-width:801px){.promo.six{display:none}}


.promo_container .promo.six img{padding-top:.25em;margin:0 auto;float:none}
.promo_container .promo.seven img{width:80%;margin:0 auto;float:none;}
...
<style>@media only screen and (min-width:50px) and (max-width:800px){
.cal_hi, .cal_low, .cal_day, .cal_date, .cal_wind{
...
<a href="http://api.openweathermap.org/data/2.5/forecast/daily?id=4377835&mode=xml&units=imperial&cnt=7&APPID=889cbe42f435f153dd8768a957fd8a82">right click save data</a>
<div class=page>
	  ...
	  <tbody>
					<tr>
						<td style="width: 100%; vertical-align: top;">
							...
							<div>
								<div class="cal_colwrap cal_dayiconhi" style="background-color: rgb(239, 239, 239);">
									<span class="cal_day">Tue</span><br>
									<span class="cal_date">Oct 2</span><br>
									<img alt="Partly Cloudy" class="Tips1" src="weather18-pcloudy.png" style="border: 0px currentColor; border-image: none;" title="Partly Cloudy"><br>
									<span class="cal_hi">84&deg;F</span>
								</div>
								<div class="cal_colwrap cal_dayiconhi" style="background-color: rgb(227, 227, 227);">
									<span class="cal_day">Wed</span><br>
									<span class="cal_date">Oct 3</span><br>
									<img alt="Partly Cloudy" class="Tips1" src="weather18-pcloudy.png" style="border: 0px currentColor; border-image: none;" title="Partly Cloudy"><br>
									<span class="cal_hi">88&deg;F</span>
								</div>
								<div class="cal_colwrap cal_dayiconhi" style="background-color: rgb(239, 239, 239);">
									<span class="cal_day">Thu</span><br>
									<span class="cal_date">Oct 4</span><br>
									<img alt="Mostly Cloudy with Light Showers Likely" class="Tips1" src="weather18-showers.png" style="border: 0px currentColor; border-image: none;" title="Mostly Cloudy with Light Showers Likely"><br>
									<span class="cal_hi">81&deg;F</span>
								</div>
								<div class="cal_colwrap cal_dayiconhi" style="background-color: rgb(227, 227, 227);">
									<span class="cal_day">Fri</span><br>
									<span class="cal_date">Oct 5</span><br>
									<img alt="Partly Cloudy" class="Tips1" src="weather18-pcloudy.png" style="border: 0px currentColor; border-image: none;" title="Partly Cloudy"><br>
									<span class="cal_hi">85&deg;F</span>
								</div>
								<div class="cal_colwrap cal_dayiconhi" style="background-color: rgb(239, 239, 239);">
									<span class="cal_day">Sat</span><br>
									<span class="cal_date">Oct 6</span><br>
									<img alt="Mostly Cloudy with Thunderstorms Likely" class="Tips1" src="weather18-tstorm.png" style="border: 0px currentColor; border-image: none;" title="Mostly Cloudy with Thunderstorms Likely"><br>
									<span class="cal_hi">76&deg;F</span>
								</div>
								<div class="cal_colwrap cal_dayiconhi" style="background-color: rgb(227, 227, 227);">
									<span class="cal_day">Sun</span><br>
									<span class="cal_date">Oct 7</span><br>
									<img alt="Mostly Cloudy with Scattered Storms" class="Tips1" src="weather18-mcloudyt.png" style="border: 0px currentColor; border-image: none;" title="Mostly Cloudy with Scattered Storms"><br>
									<span class="cal_hi">76&deg;F</span>
								</div>
								<div class="cal_colwrap cal_dayiconhi" style="background-color: rgb(239, 239, 239);">
									...
									<img alt="Mostly Cloudy with Scattered Storms" class="Tips1" src="weather18-mcloudyt.png" style="border: 0px currentColor; border-image: none;" title="Mostly Cloudy with Scattered Storms"><br>
									<span class="cal_hi">77&deg;F</span>
								</div>
								<div class="cal_colwrap cal_low" style="background-color: rgb(239, 239, 239);">
									70&deg;F
								</div>
								<div class="cal_colwrap cal_low" style="background-color: rgb(227, 227, 227);">
									69&deg;F
								</div>
								<div class="cal_colwrap cal_low" style="background-color: rgb(239, 239, 239);">
									68&deg;F
								...
								<div class="cal_colwrap" style="height: 42px; background-color: rgb(239, 239, 239);">
									<a class="Tips3" href="https://www.weatherforyou.com/reports/" onclick="return false;" title="Wind speed and direction"><span class="cal_wind">S&nbsp;11 MPH</span></a><br>
									&nbsp;
								</div>
								<div class="cal_colwrap" style="height: 42px; background-color: rgb(227, 227, 227);">
									<a class="Tips3" href="https://www.weatherforyou.com/reports/" onclick="return false;" title="Wind speed and direction"><span class="cal_wind">S&nbsp;21 MPH</span></a><br>
									&nbsp;
								</div>
								<div class="cal_colwrap" style="height: 42px; background-color: rgb(239, 239, 239);">
									<a class="Tips3" href="https://www.weatherforyou.com/reports/" onclick="return false;" title="Wind speed and direction"><span class="cal_wind">SSW&nbsp;7 MPH</span></a><br>
									<a class="Tips3" href="https://www.weatherforyou.com/reports/" onclick="return false;" title="Probability of Precipitation"><span class="cal_pop">Precip 60%</span></a>
								</div>
								<div class="cal_colwrap" style="height: 42px; background-color: rgb(227, 227, 227);">
									<a class="Tips3" href="https://www.weatherforyou.com/reports/" onclick="return false;" title="Wind speed and direction"><span class="cal_wind">S&nbsp;14 MPH</span></a><br>
									&nbsp;
								</div>
								<div class="cal_colwrap" style="height: 42px; background-color: rgb(239, 239, 239);">
									<a class="Tips3" href="https://www.weatherforyou.com/reports/" onclick="return false;" title="Wind speed and direction"><span class="cal_wind">S&nbsp;11 MPH</span></a><br>
									<a class="Tips3" href="https://www.weatherforyou.com/reports/" onclick="return false;" title="Probability of Precipitation"><span class="cal_pop">Precip 80%</span></a>
								</div>
								<div class="cal_colwrap" style="height: 42px; background-color: rgb(227, 227, 227);">
									<a class="Tips3" href="https://www.weatherforyou.com/reports/" onclick="return false;" title="Wind speed and direction"><span class="cal_wind">SE&nbsp;13 MPH</span></a><br>
									<a class="Tips3" href="https://www.weatherforyou.com/reports/" onclick="return false;" title="Probability of Precipitation"><span class="cal_pop">Precip 60%</span></a>
								</div>
								<div class="cal_colwrap" style="height: 42px; background-color: rgb(239, 239, 239);">
									<a class="Tips3" href="https://www.weatherforyou.com/reports/" onclick="return false;" title="Wind speed and direction"><span class="cal_wind">SSE&nbsp;14 MPH</span></a><br>
									<a class="Tips3" href="https://www.weatherforyou.com/reports/" onclick="return false;" title="Probability of Precipitation"><span class="cal_pop">Precip 40%</span></a>
								</div>
							</div>
							</td>
...
<script>const CURRENT_LOCATION = document.getElementsByClassName('weather-content__overview')[0];
...
<div class="component__weather-box">
  ...
  <div class="component__forecast-box"></div>
	    ...
	    <table onclick="location.href='https://www.weatherforyou.com/reports/index.php?config=warningsbox&forecast=zandh&pands=&zipcode=65613&place=bolivar&state=mo&country=us&icao='" < style="border: 0px currentColor; border-image: none; width: 473px; background-color: white;">
	  <tbody>
					<tr>
						<td style="width: 100%; vertical-align: top;">
...
<SCRIPT src="weather18_files/jquery.min.js"></SCRIPT>
 
<SCRIPT src="weather18_files/jquery-ui.min.js"></SCRIPT>
     
<SCRIPT src="weather18_files/mapbox.js"></SCRIPT>
     
<SCRIPT src="weather18_files/aeris.js"></SCRIPT>
     
<SCRIPT src="weather18_files/apikeys.js"></SCRIPT>
